...
2. Provisions infrastructure via Pulumi (D1, KV, R2, DNS), including private VM diagnostic evidence, one-day temporary uploads, and thirty-day TTS cache objects (`infra/resources/storage.ts:r2BucketLifecycle`)
3. Runs database migrations
4. Deploys API Worker and Web UI
